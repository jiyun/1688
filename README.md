...
#### 右键菜单增强
- **铺货页面**：右键菜单新增"铺货页面"选项，一键复制铺货链接到剪贴板
- **店铺上新**：右键菜单新增"店铺上新"选项，一键复制淘宝上新链接到剪贴板
- **菜单分隔符**：优化菜单分组，添加分隔符提高可读性

#### GUI界面优化
- **字体配置**：支持自定义字体，优先使用阿里巴巴普惠体、HarmonyOS Sans、MiSans、OPPO Sans等字体
- **使用说明渲染**：使用说明选项卡支持 Markdown 渲染，提供更好的阅读体验
- **配置文件清理**：移除未使用的配置项，简化配置文件结构

#### 图片处理优化
- **主图提取修复**：修复新版1688页面主图提取问题，支持 ant-image-img 结构
- **色卡名称清理**：自动清理色卡名称中的不安全字符，避免文件创建错误
- **目标宽度修复**：修复混合尺寸图片处理时目标宽度计算错误问题
